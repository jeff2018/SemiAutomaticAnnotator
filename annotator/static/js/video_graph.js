...
function drawVideoGraph(data) {
    ...
    nodes.append('circle')
        ...
        .tween('circleIn', (d) => {
            let i = d3.interpolateNumber(0, scaleRadius(d.nbrmentions));
            return (t) => {
                d.r = i(t);
            ...
            if (!target.closest(".circle") && focusNode) {
                ...
                d3.transition().duration(1000).ease(d3.easePolyOut)
                    .tween('moveOut', function () {
                        ...
                        let ir = d3.interpolateNumber(focusNode.r, scaleRadius(focusNode.nbrmentions))
                        return function (t) {
                            focusNode.r = ir(t)
                            simulation.force('collide', forceCollide)
                        }
    ...
    async function deselect(nodeClicked) {
        ...
        nodes.filter(function (d, i) {
            ...
            .tween("deselect", function (d) {
                let irl = d3.interpolateNumber(nodeClicked.r, scaleRadius(nodeClicked.nbrmentions))
                return function (t) {
                    nodeClicked.r = irl(t)
                    simulation.force('collide', forceCollide)
            ...
            .on('interrupt', () => {
                ...
                nodeClicked.r = scaleRadius(nodeClicked.nbrmentions);
            ...
            let nodeSelection = d3.selectAll('.node').filter(function (d, i) {
                    ...
                    .tween('circleOut', await
                        ...
                        function () {
                            ...
                            let irl = d3.interpolateNumber(lastNode.r, scaleRadius(lastNode.nbrmentions))
                            return function (t) {
                                lastNode.r = irl(t)
                            }
                        }
                    ...
                    .on('interrupt', () => {
                        lastNode.r = scaleRadius(lastNode.nbrmentions);
