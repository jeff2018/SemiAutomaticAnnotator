...
/**
 * A boundary class for aLMA concept mapping factories. It communicates with
 * {@link ALMAConceptMappingFactory}, {@link ALMAConceptMapping},
 * {@link ALMAPluginActivator}, and other 4 classes, and consists mostly of
 * mutators to the aLMA concept mapping factory's state.
 * <p>
 * It allows managing:
 * <ul>
 * <li>instance;</li>
 * <li>download schemes; and</li>
 * <li>renamed URI.</li>
 * </ul>
 * <p>
 * It also allows:
 * <ul>
 * <li>getting label test.</li>
 * </ul>
 */
